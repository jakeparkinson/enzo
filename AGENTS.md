...
1. **Tests** — prioritize integration tests around order creation (cost + ready-date calculation) since that's the core business logic; unit test pure helpers; skip e2e given time budget.
